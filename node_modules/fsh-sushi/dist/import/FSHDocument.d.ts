import { Profile, Extension, Instance, FshValueSet, FshCodeSystem, Invariant, RuleSet, Mapping } from '../fshtypes';
export declare class FSHDocument {
    ...
    readonly appliedRuleSets: Map<string, RuleSet>;
