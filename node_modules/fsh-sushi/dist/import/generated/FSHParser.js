...
var ruleNames = ["doc", "entity", "alias", "profile", "extension", "sdMetadata",
    ...
    "ruleSetRule", "paramRuleSet", "paramRuleSetContent",
    "mapping", "mappingMetadata", "mappingEntityRule", "parent",
    "id", "title", "description", "expression", "xpath",
    "severity", "instanceOf", "usage", "mixins", "source",
    "target", "cardRule", "flagRule", "valueSetRule", "fixedValueRule",
    "containsRule", "onlyRule", "obeysRule", "caretValueRule",
    "mappingRule", "insertRule", "vsComponent", "vsConceptComponent",
...
EntityContext.prototype.paramRuleSet = function () {
...
RuleSetContext.prototype.RULESET_REFERENCE = function () {
...
function ParamRuleSetContext(parser, parent, invokingState) {
    if (parent === undefined) {
        parent = null;
    }
    if (invokingState === undefined || invokingState === null) {
...
ParamRuleSetContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
ParamRuleSetContext.prototype.constructor = ParamRuleSetContext;
ParamRuleSetContext.prototype.KW_RULESET = function () {
    return this.getToken(FSHParser.KW_RULESET, 0);
};
ParamRuleSetContext.prototype.PARAM_RULESET_REFERENCE = function () {
    return this.getToken(FSHParser.PARAM_RULESET_REFERENCE, 0);
};
ParamRuleSetContext.prototype.paramRuleSetContent = function () {
    return this.getTypedRuleContext(ParamRuleSetContentContext, 0);
};
ParamRuleSetContext.prototype.enterRule = function (listener) {
    if (listener instanceof FSHListener) {
        listener.enterParamRuleSet(this);
    }
};
ParamRuleSetContext.prototype.exitRule = function (listener) {
    if (listener instanceof FSHListener) {
        listener.exitParamRuleSet(this);
    }
};
ParamRuleSetContext.prototype.accept = function (visitor) {
    if (visitor instanceof FSHVisitor) {
...
FSHParser.prototype.paramRuleSet = function () {
    var localctx = new ParamRuleSetContext(this, this._ctx, this.state);
...
function ParamRuleSetContentContext(parser, parent, invokingState) {
    if (parent === undefined) {
        parent = null;
    }
    if (invokingState === undefined || invokingState === null) {
...
ParamRuleSetContentContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
ParamRuleSetContentContext.prototype.constructor = ParamRuleSetContentContext;
ParamRuleSetContentContext.prototype.STAR = function () {
    return this.getToken(FSHParser.STAR, 0);
};
ParamRuleSetContentContext.prototype.KW_PROFILE = function (i) {
    if (i === undefined) {
        i = null;
    }
    if (i === null) {
...
ParamRuleSetContentContext.prototype.KW_ALIAS = function (i) {
    if (i === undefined) {
        i = null;
    }
    if (i === null) {
...
ParamRuleSetContentContext.prototype.KW_EXTENSION = function (i) {
    if (i === undefined) {
        i = null;
    }
    if (i === null) {
...
ParamRuleSetContentContext.prototype.KW_INSTANCE = function (i) {
    if (i === undefined) {
        i = null;
    }
    if (i === null) {
...
ParamRuleSetContentContext.prototype.KW_INVARIANT = function (i) {
    if (i === undefined) {
        i = null;
    }
    if (i === null) {
...
ParamRuleSetContentContext.prototype.KW_VALUESET = function (i) {
    if (i === undefined) {
        i = null;
    }
    if (i === null) {
...
ParamRuleSetContentContext.prototype.KW_CODESYSTEM = function (i) {
    if (i === undefined) {
        i = null;
    }
    if (i === null) {
...
ParamRuleSetContentContext.prototype.KW_RULESET = function (i) {
    if (i === undefined) {
        i = null;
    }
    if (i === null) {
...
ParamRuleSetContentContext.prototype.KW_MAPPING = function (i) {
    if (i === undefined) {
        i = null;
    }
    if (i === null) {
...
ParamRuleSetContentContext.prototype.enterRule = function (listener) {
    if (listener instanceof FSHListener) {
        listener.enterParamRuleSetContent(this);
    }
};
ParamRuleSetContentContext.prototype.exitRule = function (listener) {
    if (listener instanceof FSHListener) {
        listener.exitParamRuleSetContent(this);
    }
};
ParamRuleSetContentContext.prototype.accept = function (visitor) {
    if (visitor instanceof FSHVisitor) {
...
FSHParser.prototype.paramRuleSetContent = function () {
    var localctx = new ParamRuleSetContentContext(this, this._ctx, this.state);
...
InsertRuleContext.prototype.RULESET_REFERENCE = function () {
    return this.getToken(FSHParser.RULESET_REFERENCE, 0);
};
InsertRuleContext.prototype.PARAM_RULESET_REFERENCE = function () {
    return this.getToken(FSHParser.PARAM_RULESET_REFERENCE, 0);
};
...
QuantityContext.prototype.STRING = function () {
    return this.getToken(FSHParser.STRING, 0);
};
