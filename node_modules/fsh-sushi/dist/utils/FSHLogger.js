...
function switchToSecretLogger() {
    ...
    const oldErrorsAndWarnings = cloneDeep_1.default(exports.errorsAndWarnings);
    exports.errorsAndWarnings.reset();
    exports.errorsAndWarnings.shouldTrack = true;
    const oldStats = cloneDeep_1.default(exports.stats);
    exports.stats.reset();
...
function restoreMainLogger(loggerDataToRestore) {
    ...
    const secretErrorsAndWarnings = cloneDeep_1.default(exports.errorsAndWarnings);
    exports.errorsAndWarnings.reset();
