...
class MappingExporter {
    ...
    exportMapping(fshDefinition) {
        ...
        if (sourceStructDef) {
            const parent = this.fisher.fishForFHIR(sourceStructDef.baseDefinition, utils_1.Type.Resource, utils_1.Type.Type, utils_1.Type.Profile, utils_1.Type.Extension);
            const matchingParentMapping = parent === null || parent === void 0 ? void 0 : parent.mapping.find((m) => m.identity === fshDefinition.id);
