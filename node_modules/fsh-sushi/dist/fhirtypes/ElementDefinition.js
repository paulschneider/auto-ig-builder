...
class ElementDefinitionType {
    ...
    get code() {
        ...
        return (_c = (_b = fhirTypeExtension === null || fhirTypeExtension === void 0 ? void 0 : fhirTypeExtension.valueUrl) !== null && _b !== void 0 ? _b : fhirTypeExtension === null || fhirTypeExtension === void 0 ? void 0 : fhirTypeExtension.valueUri) !== null && _c !== void 0 ? _c : this._code;
    }
    set code(c) {
        this._code = c;
    }
...
class ElementDefinition {
        ...
        if (connectedElements.length > 0) {
            ...
            connectedElements.forEach(ce => {
                ...
                if (ce.max != null && ce.max != '*' && maxInt != null && maxInt < parseInt(ce.max)) {
                    throw new errors_1.NarrowingRootCardinalityError(this.path, ce.id, min, max, (_a = ce.min) !== null && _a !== void 0 ? _a : 0, ce.max);
                }
            });
        }
    ...
    bindToVS(vsURI, strength) {
        ...
        if (((_a = listElement === null || listElement === void 0 ? void 0 : listElement.binding) === null || _a === void 0 ? void 0 : _a.valueSet) == vsURI &&
            strengths.indexOf(strength) < strengths.indexOf((_b = listElement === null || listElement === void 0 ? void 0 : listElement.binding) === null || _b === void 0 ? void 0 : _b.strength)) {
            throw new errors_1.BindingStrengthError((_c = listElement === null || listElement === void 0 ? void 0 : listElement.binding) === null || _c === void 0 ? void 0 : _c.strength, strength);
        }
    ...
    assignValue(value, exactly = false, fisher) {
        ...
        switch (type) {
            ...
            case 'Reference':
                ...
                if (value.sdType && this.type[0].targetProfile) {
                    ...
                    this.type[0].targetProfile.forEach(tp => {
                        var _a;
                        const tpType = (_a = fisher.fishForMetadata(tp)) === null || _a === void 0 ? void 0 : _a.sdType;
                        if (tpType) {
                    ...
                    if (!referenceLineage.some(md => validTypes.includes(md.sdType))) {
                        throw new errors_1.InvalidTypeError(`Reference(${value.sdType})`, this.type);
                    }
                }
            ...
            case 'Canonical':
                ...
                const canonicalDefinition = fisher.fishForMetadata(value.entityName, utils_1.Type.Resource, utils_1.Type.Type, utils_1.Type.Profile, utils_1.Type.Extension, utils_1.Type.ValueSet, utils_1.Type.CodeSystem, utils_1.Type.Instance);
                let canonicalUrl;
            ...
            case 'InstanceDefinition':
                ...
                this.assignFHIRValue(stringVal, value.toJSON(), exactly, (_a = value._instanceMeta.sdType) !== null && _a !== void 0 ? _a : value.resourceType);
                break;
            default:
                type = (_c = (typeof value === 'object' && ((_b = value.constructor) === null || _b === void 0 ? void 0 : _b.name))) !== null && _c !== void 0 ? _c : type;
        ...
        parentSlices.forEach(parentSlice => {
            ...
            if (((_a = slicedElement.slicing.discriminator) === null || _a === void 0 ? void 0 : _a.some(d => `${slicedElement.path}${d.path === '$this' ? '' : `.${d.path}`}` === this.path &&
     ...
     * @throws {MismatchedTypeError} when the value does not match the type of the ElementDefinition
     */
    assignFHIRValue(fshValue, fhirValue, exactly, type) {
        var _a, _b;
    ...
    checkChildAssignedValue(child, fhirValue) {
        var _a;
        const childType = child.type[0].code;
        const fixedX = `fixed${lodash_1.upperFirst(childType)}`;
        const patternX = `pattern${lodash_1.upperFirst(childType)}`;
        ...
        if (currentChildValue != null) {
            ...
            for (const pathPart of childPath) {
                newChildValue = lodash_1.flatten(newChildValue.map(value => {
    ...
    checkAssignInlineInstance(value, fisher) {
        ...
        if ((_b = this.type) === null || _b === void 0 ? void 0 : _b.some(t => lineage.includes(t.code))) {
            ...
            throw new errors_1.MismatchedTypeError(inlineInstanceType, value.id, (_c = this.type) === null || _c === void 0 ? void 0 : _c.map(t => t.code).join(', '));
        }
    }
    /**
    ...
    assignFshCode(code, exactly = false, fisher) {
        ...
        if (type === 'code' || type === 'string' || type === 'uri') {
            ...
            const existing = (_b = (_a = this.fixedQuantity) !== null && _a !== void 0 ? _a : this.patternQuantity) !== null && _b !== void 0 ? _b : this.assignedByAnyParent();
    ...
    unfold(fisher) {
        ...
        if ((((_a = this.type) === null || _a === void 0 ? void 0 : _a.length) === 1 && ((_b = this.type[0].profile) !== null && _b !== void 0 ? _b : []).length <= 1) ||
            ...
            if (this.contentReference) {
                ...
                if (json) {
                    ...
                    const referencedElement = def.findElement(this.contentReference.slice(this.contentReference.indexOf('#') + 1));
                    newElements = referencedElement === null || referencedElement === void 0 ? void 0 : referencedElement.children().map(e => {
            ...
            if (newElements.length === 0) {
                ...
                const type = (_d = (_c = this.type[0].profile) === null || _c === void 0 ? void 0 : _c[0]) !== null && _d !== void 0 ? _d : this.type[0].code;
    ...
    unfoldChoiceElementTypes(fisher) {
        ...
        const sharedAncestry = lodash_1.intersectionWith(...allTypeAncestry);
