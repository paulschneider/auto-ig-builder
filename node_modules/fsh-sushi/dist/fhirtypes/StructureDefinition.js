...
class StructureDefinition {
    ...
    addElement(element) {
        ...
        for (; i < this.elements.length; i++) {
            ...
            if (new RegExp(`^${escapeRegExp_1.default(currentId)}[.:/]`).test(element.id)) {
                lastMatchId = currentId;
            }
            else if (!new RegExp(`^${escapeRegExp_1.default(lastMatchId)}[./:]`).test(currentId) ||
                // If element is not a slice at this level, and the currentId is a slice, break to add children before slices
                (new RegExp(`^${escapeRegExp_1.default(lastMatchId)}[.]`).test(element.id) &&
                    new RegExp(`^${escapeRegExp_1.default(lastMatchId)}[:/]`).test(currentId))) {
                break;
            }
        }
    ...
    findElementByPath(path, fisher) {
        ...
        const parsedPath = utils_1.parseFSHPath(path);
    ...
    toJSON(snapshot = true) {
        ...
        for (const prop of PROPS) {
            ...
            if (this[`_${prop}`] !== undefined) {
                // @ts-ignore
                j[`_${prop}`] = cloneDeep_1.default(this[`_${prop}`]);
            }
        }
        ...
        this.elements.forEach(e => {
            ...
            if (e.hasDiff()) {
                ...
                const isTypeSlicingChoiceDiff = diff.id.endsWith('[x]') &&
                    Object.keys(diff).length === 3 &&
                    diff.id &&
                    diff.path &&
                    ((_b = (_a = diff.slicing) === null || _a === void 0 ? void 0 : _a.discriminator) === null || _b === void 0 ? void 0 : _b.length) === 1 &&
     ...
     */
    validateValueAtPath(path, value, fisher, inlineResourceTypes = []) {
        var _a, _b, _c, _d, _e, _f;
        const pathParts = utils_1.parseFSHPath(path);
        let currentPath = '';
        let previousPath = '';
        let currentElement;
        let previousElement;
        for (const [i, pathPart] of pathParts.entries()) {
            ...
            if (!currentElement &&
                ...
                ((_b = previousElement === null || previousElement === void 0 ? void 0 : previousElement.type) === null || _b === void 0 ? void 0 : _b.length) === 1) {
                if (common_1.isInheritedResource(value, previousElement.type[0].code, fisher)) {
            ...
            const nonArrayElementIsBasedOnArray = ((_c = currentElement === null || currentElement === void 0 ? void 0 : currentElement.base) === null || _c === void 0 ? void 0 : _c.max) !== '0' &&
                ((_d = currentElement === null || currentElement === void 0 ? void 0 : currentElement.base) === null || _d === void 0 ? void 0 : _d.max) !== '1' &&
                ((currentElement === null || currentElement === void 0 ? void 0 : currentElement.max) === '0' || (currentElement === null || currentElement === void 0 ? void 0 : currentElement.max) === '1');
            if (!currentElement ||
            ...
            if (inlineResourceTypes.length > 0 &&
                ...
                common_1.isInheritedResource(inlineResourceTypes[i], currentElement.type[0].code, fisher, true)) {
                ...
                if (inlineResourceJSON) {
                    ...
                    const inlinePath = utils_1.assembleFSHPath(pathParts.slice(i + 1));
                    try {
    ...
    sliceMatchingValueX(fhirPath, elements) {
        ...
        if (matchingXElements.length > 0) {
            ...
            if (matchingSlice) {
                ...
                matchingXElement.sliceIt('type', '$this', (_a = matchingXElement.slicing) === null || _a === void 0 ? void 0 : _a.ordered, (_b = matchingXElement.slicing) === null || _b === void 0 ? void 0 : _b.rules);
    ...
    findMatchingSlice(pathPart, elements, fisher) {
        ...
        if (!matchingSlice && ((_a = pathPart.brackets) === null || _a === void 0 ? void 0 : _a.length) === 1) {
            ...
            for (const e of elements) {
                ...
                const matchingConnectedSlice = connectedSliceElement === null || connectedSliceElement === void 0 ? void 0 : connectedSliceElement.getSlices().find(e => e.sliceName === pathPart.brackets.join('/'));
