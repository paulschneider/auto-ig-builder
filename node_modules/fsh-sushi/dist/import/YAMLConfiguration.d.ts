 ...
 */
export declare type YAMLConfiguration = {
    canonical: string;
...
export declare type YAMLConfigurationMeta = {
...
export declare type YAMLConfigurationNarrative = {
    status: Narrative['status'] | '#generated' | '#extensions' | '#additional' | '#empty';
    div: Narrative['div'];
};
export declare type YAMLConfigurationStatus = ImplementationGuideStatus | '#draft' | '#active' | '#retired' | '#unknown';
export declare type YAMLConfigurationPublisher = {
    name: ImplementationGuide['publisher'];
    url?: ContactPoint['value'];
    email?: ContactPoint['value'];
};
export declare type YAMLConfigurationContactDetail = {
    name?: ContactDetail['name'];
    telecom?: YAMLConfigurationContactPoint[];
};
export declare type YAMLConfigurationContactPoint = {
...
export declare type YAMLConfigurationUsageContext = {
...
export declare type YAMLConfigurationQuantity = {
...
export declare type YAMLConfigurationRange = {
    low?: YAMLConfigurationQuantity | string;
    high?: YAMLConfigurationQuantity | string;
};
export declare type YAMLConfigurationReference = {
    reference?: Reference['reference'];
    type?: Reference['type'];
    identifier?: YAMLConfigurationIdentifier;
    display?: Reference['display'];
};
export declare type YAMLConfigurationIdentifier = {
...
export declare type YAMLConfigurationJurisdiction = ImplementationGuide['jurisdiction'][0] | string;
export declare type YAMLConfigurationDependencyMap = {
    [key: string]: ImplementationGuideDependsOn['version'] | number | YAMLConfigurationDependencyDetails;
};
export declare type YAMLConfigurationDependencyDetails = {
...
export declare type YAMLConfigurationGlobalMap = {
    [key: string]: ImplementationGuideGlobal['profile'] | ImplementationGuideGlobal['profile'][];
};
export declare type YAMLConfigurationGroupMap = {
    [key: string]: {
        name?: ImplementationGuide['name'];
...
export declare type YAMLConfigurationResourceMap = {
    [key: string]: 'omit' | '#omit' | YAMLConfigurationResource;
};
export declare type YAMLConfigurationResource = {
...
export declare type YAMLConfigurationPageTree = {
    [key: string]: YAMLConfigurationPage;
};
export declare type YAMLConfigurationPage = null | {
    ...
    [key: string]: YAMLConfigurationPage | string;
};
export declare type YAMLConfigurationParameterMap = {
    [key: string]: string | number | boolean | (string | number | boolean)[];
};
export declare type YAMLConfigurationMenuTree = {
    [key: string]: string | YAMLConfigurationMenuTree;
};
export declare type YAMLConfigurationHistory = {
    'package-id'?: string;
    canonical?: string;
    title?: string;
    introduction?: string;
...
export declare type YAMLConfigurationHistoryItem = {
    date?: string | number;
    desc?: string;
    path: string;
    changes?: string;
